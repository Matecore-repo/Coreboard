...
| `viewer` | Solo lectura | ✅ Solo ver datos | ✅ Solo SELECT |
...
- Validación antes de crear turno: empleado debe estar asignado activamente al salón.
...
CREATE TABLE public.invitations (
  ...
  organization_id  uuid REFERENCES app.organizations(id), -- NULL para admin (no pertenece a org específica),
...
### Regla de Oro: Empleados
- ✅ **user_id obligatorio**: No existe empleado sin usuario autenticado
- ✅ **Validación en BD**: Constraint `employees_user_id_required`
- ✅ **Validación en Frontend**: `employeeValidator.ts` filtra empleados sin user_id
- ✅ **Asignaciones**: Tabla `salon_employees` para asignar empleados a salones
