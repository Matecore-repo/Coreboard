...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => { /* locked until creation */ }}>
      <DialogContent className="locked-modal w-[92vw] sm:max-w-[640px] max-h-[85vh] overflow-y-auto rounded-2xl p-6 sm:p-8 border-0 shadow-xl">        <div className="relative overflow-hidden rounded-2xl">          <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-primary/5" />          <div className="absolute -top-8 -right-10 h-28 w-28 rounded-full bg-primary/15 blur-2xl" />          <div className="absolute -bottom-10 -left-10 h-24 w-24 rounded-full bg-primary/10 blur-2xl" />          <div className="p-1 relative"><div className="bg-background rounded-xl p-5 sm:p-6 space-y-6">
